            ...
            <div class="content_body add_book_content">
                ...
                <div class="content_right">
                    ...
                    <div>
                        ...
                        <c:if test="${empty bookDetailsInfo}">
                            <input type="text" name="publishDate" value="" autocomplete="off" placeholder="YYYYMMDD">
                        </c:if>
                    </div>
                    <div>
                        <span>ISBN</span><span class="care care1">任意</span>
                        <c:if test="${!empty bookDetailsInfo}">
                            <input type="text" name="isbn" autocomplete="off" value="${bookDetailsInfo.isbn}">
                        </c:if>
                        <c:if test="${empty bookDetailsInfo}">
                    ...
                    <div>
                        ...
                        <c:if test="${!empty bookDetailsInfo}">
                            <input type="text" name="explain" autocomplete="off" value="${bookDetailsInfo.explain}">
                        </c:if>
                        <c:if test="${empty bookDetailsInfo}">
